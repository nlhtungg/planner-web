...
const logger = require('../utils/logger').child({ module: 'controllers/groupController2' });
...
exports.addReaction = async (req, res) => {
  try {
    ...
    const message = await groupRepository.addReactionToGroupMessage(messageId, userId, emoji);
...
exports.removeReaction = async (req, res) => {
  try {
    ...
    const message = await groupRepository.removeReactionFromGroupMessage(messageId, userId);
